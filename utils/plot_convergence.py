...
# --------- CONFIG ---------
LOG_PATH = Path("../logs/v2/log-FedAvg-20260331_155540.txt")  # change if needed
OUT_DIR = Path("../results/plots_convergence_sign_flip_augment_v2_m4")
DPI = 640
...
def plot_and_save(x, y, title, ylabel, filename):
    ...
    # Add value labels at each point for easy convergence visualization
